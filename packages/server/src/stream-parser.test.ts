...
describe("parseStreamMessage", () => {
  ...
  describe("system", () => {
    ...
    it("returns null for task_started subtype", () => {
      const result = parseStreamMessage({
        type: "system",
    ...
    it("returns null for task_progress subtype", () => {
      const result = parseStreamMessage({
        type: "system",
    ...
    it("returns dispatch-log when task_notification carries a chat array", () => {
      const result = parseStreamMessage({
        type: "system",
        subtype: "task_notification",
        chat: [
          { role: "user", content: "run investigation" },
    ...
    it("returns task-notification with description when no chat is present", () => {
      const result = parseStreamMessage({
        type: "system",
        subtype: "task_notification",
        description: "Sub-agent started",
      });
      expect(result).toEqual({
        type: "system",
        subtype: "task-notification",
        content: "Sub-agent started",
        timestamp: expect.any(Number),
      });
    });

    it("returns empty dispatch-log when task_notification has neither chat nor description", () => {
      const result = parseStreamMessage({
        type: "system",
        subtype: "task_notification",
      });
